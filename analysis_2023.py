...
def analysis_chushi():
    pd_data = load_total_score_dataframe()
    series_电子信息 = pd_data[pd_data.专业 == "电子信息"]
    series_学硕_计科 = pd_data[pd_data.专业 == "计算机科学与技术"]
    series_学硕_软工 = pd_data[pd_data.专业 == "软件工程"]
    series_学硕_网安 = pd_data[pd_data.专业 == "网络空间安全"]
