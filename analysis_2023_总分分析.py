...
bins_chushi = [330, 340, 350, 360, 370, 380, 390, 400, 410, 420]
bins_fushi = [210, 220, 230, 240, 250, 260, 270, 280, 290]
title_chushi = "熊二(2024南航计算机考研群：717645993)：2023录取结果分析 - 初试总分分析"
title_fushi = "熊二(2024南航计算机考研群：717645993)：2023录取结果分析 - 复试总分分析"


def load_total_score_dataframe():
    """加载 2023录取数据-总分.txt"""
    file = "source_data/2023录取结果.txt"
...
def analysis_total_score():
    ...
    pd_data_group_describe.to_csv("2023-初复试总分分析.csv", encoding="utf8")
...
def analysis_chushi():
    ...
    ax.text(2, 18, "熊二(2024南航计算机考研群：717645993) \n 2023录取结果分析 - 初试总分分析", fontsize=25, color="red")

    fig = ax.get_figure()
    plt.show()
    fig.savefig('2023初试.png', dip=500)
...
def analysis_fushi():
    ...
    ax.text(2, 18, "熊二(2024南航计算机考研群：717645993) \n 2023录取结果分析 - 复试总分分析", fontsize=25, color="red")

    fig = ax.get_figure()
    plt.show()
    fig.savefig('2023复试.png', dip=500)
    pass
