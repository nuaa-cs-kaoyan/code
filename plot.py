...
x = [1, 2, 3]
# data
x_label = ["2017届", "2018届", "2019届"]
y_统考_录取人数 = [90, 102, 139]
y_985调剂_录取人数 = [18, 46, 39]
y_学硕_计算机_录取人数 = [25, 27, 31]
y_学硕_软工_录取人数 = [12, 12, 15]
y_学硕_安全_录取人数 = [4, 12, 15]
y_专硕_录取人数 = [49, 51, 78]
