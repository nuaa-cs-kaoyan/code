...
x = [1, 2, 3, 4, 5, 6, 7, 8]
# data
x_label = ["2017届", "2018届", "2019届", "2020届", "2021届", "2022届", "2023届", "2024届计划"]
y_统考_录取人数 = [90, 102, 139, 220, 176, 151, 136, 136]
y_985调剂_录取人数 = [18, 46, 39, 0, 0, 0, 0, 0]
y_学硕_计算机_录取人数 = [25, 27, 31, 36, 25, 30, 29, 29]
y_学硕_软工_录取人数 = [12, 12, 15, 24, 19, 17, 17, 17]
y_学硕_网安_录取人数 = [4, 12, 15, 24, 25, 21, 16, 16]
y_专硕_录取人数 = [49, 51, 78, 136, 107, 83, 74, 74]
...
plt.ylabel("人数")
plt.title("南航计算机考研历年统考录取情况-2024招生计划版 \n 熊二 2024南航计算机考研群：717645993")
